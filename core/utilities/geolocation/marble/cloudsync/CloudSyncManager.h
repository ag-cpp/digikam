...
class DIGIKAM_EXPORT CloudSyncManager : public QObject
{
    Q_OBJECT
...
public:
    ...
    /**
     * Change owncloud server URL, username and password at once without Q_EMITting change
     * signals like setOwncloudServer, setOwncloudUsername, setOwncloudPassword do.
     * The apiUrlChanged signal is Q_EMITted, if needed, however.
