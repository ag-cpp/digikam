...
//
// SPDX-FileCopyrightText: 2013 Mihail Ivchenko <ematirov@gmail>
...
void TourWidget::handleSliderMove( int value )
{
    ...
    d->m_tourUi.m_elapsedTime->setText(QString::fromUtf8("%L1:%L2").arg(time.minute(), 2, 10, QLatin1Char('0')).arg(time.second(), 2, 10, QLatin1Char('0')));
}
...
void TourWidgetPrivate::updateRootIndex()
{
    ...
    if ( tour ){
        ...
        m_tourUi.m_totalTime->setText(QString::fromUtf8("%L1:%L2").arg(time.minute(), 2, 10, QLatin1Char('0')).arg(time.second(), 2, 10, QLatin1Char('0')));
...
void TourWidget::updateDuration()
{
    ...
    d->m_tourUi.m_totalTime->setText(QString::fromUtf8("%L1:%L2").arg(totalTime.minute(), 2, 10, QLatin1Char('0') ).arg(totalTime.second(), 2, 10, QLatin1Char('0')));
    d->m_tourUi.m_slider->setValue( 0 );
    d->m_tourUi.m_elapsedTime->setText(QString::fromUtf8("%L1:%L2").arg(0, 2, 10, QLatin1Char('0')).arg(0, 2, 10, QLatin1Char('0')));
}
...
void TourWidgetPrivate::handlePlaybackProgress(const double position)
{
    if( !m_tourUi.m_slider->isSliderDown() ){
        ...
        m_tourUi.m_elapsedTime->setText(QString::fromUtf8("%L1:%L2").arg(time.minute(), 2, 10, QLatin1Char('0')).arg(time.second(), 2, 10, QLatin1Char('0')));
    }
}
