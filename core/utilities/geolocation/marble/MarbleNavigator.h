...
class DIGIKAM_EXPORT MarbleNavigator : public QWidget
{
    Q_OBJECT
 ...
 Q_SIGNALS:
    /**
     * @brief Signal Q_EMITted when the Home button has been pressed.
     */
    void goHome();
    /**
     * @brief Signal Q_EMITted when the Zoom In button has been pressed.
     */
    void zoomIn();
    /**
     * @brief Signal Q_EMITted when the Zoom Out button has been pressed.
     */
    void zoomOut();
    /**
     * @brief Signal Q_EMITted when the zoom slider has been moved.
     * @param zoom  The new zoom value.
     */
    void zoomChanged(int zoom);

    /**
     * @brief Signal Q_EMITted when the Move Left button has been pressed.
     */
    void moveLeft();
    /**
     * @brief Signal Q_EMITted when the Move Right button has been pressed.
     */
    void moveRight();
    /**
     * @brief Signal Q_EMITted when the Move Up button has been pressed.
     */
    void moveUp();
    /**
     * @brief Signal Q_EMITted when the Move Down button has been pressed.
     */
    void moveDown();
 ...
 public Q_SLOTS:
     ...
     * doesn't Q_EMIT the zoomChanged signal.
     */
