...
MarbleSettingsContainer::MarbleSettingsContainer()
    : exifRotate            (true),
...
QStringList MarbleSettingsContainer::defaultExifToolSearchPaths() const
{
...
{
    dbg.nospace() << "[MarbleSettingsContainer] exifRotate("
                  << inf.exifRotate << "), ";
