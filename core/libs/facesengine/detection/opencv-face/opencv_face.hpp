 ...
 *
 * Date        : 2010-01-03
 * Description : Abstract base class for all face recognition models.
...
#ifndef DIGIKAM_OPENCV_FACE_HPP
#define DIGIKAM_OPENCV_FACE_HPP
