...
const AltLangStrEdit::LanguageCodeMap AltLangStrEdit::s_rfc3066ForXMP =
{
    ...
    { QLatin1String("bo-CN"),     QString::fromUtf8(I18N_NOOP2("@info: country code", "Tibetan (PRC)")                            )},
    ...
    { QLatin1String("he-IL"),     QString::fromUtf8(I18N_NOOP2("@info: country code", "Hebrew (Israel)")                          )},
    ...
    { QLatin1String("id-ID"),     QString::fromUtf8(I18N_NOOP2("@info: country code", "(Indonesian)")                             )},
    { QLatin1String("ii-CN"),     QString::fromUtf8(I18N_NOOP2("@info: country code", "Yi (PRC)")                                 )},
    ...
    { QLatin1String("kw-GB"),     QString::fromUtf8(I18N_NOOP2("@info: country code", "Cornish (United Kingdom)")                 )},
    ...
    { QLatin1String("mn-CN"),     QString::fromUtf8(I18N_NOOP2("@info: country code", "Mongolian (PRC)")                          )},
    ...
    { QLatin1String("ug-CN"),     QString::fromUtf8(I18N_NOOP2("@info: country code", "Uighur (PRC)")                             )},
    ...
    { QLatin1String("zh-CN"),     QString::fromUtf8(I18N_NOOP2("@info: country code", "Chinese (PRC)")                            )},
    { QLatin1String("zh-HK"),     QString::fromUtf8(I18N_NOOP2("@info: country code", "Chinese (Hong Kong SAR, PRC)")             )},
