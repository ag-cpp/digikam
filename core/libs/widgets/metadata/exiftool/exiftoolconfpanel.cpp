...
/*
    ...
    if (frm == QLatin1String("BTF                     return i18n("BigTIFF (64-bit Tagged Image File Format)
    if (frm == QLatin1String("CHM                     return i18n("Microsoft Compiled HTML format
    if (frm == QLatin1String("COS                     return i18n("Capture One Settings (XML-based)
    if (frm == QLatin1String("CR2                     return i18n("Canon RAW 2 (TIFF-based) (CR2 spec)
    if (frm == QLatin1String("CR3                     return i18n("Canon RAW 3 (QuickTime-based) (CR3 spec)
    if (frm == QLatin1String("CRM                     return i18n("Canon RAW Movie (QuickTime-based)
    if (frm == QLatin1String("CRW, CIFF               return i18n("Canon RAW Camera Image File Format (CRW spec)
    if (frm == QLatin1String("CS1                     return i18n("Sinar CaptureShop 1-shot RAW (PSD-based)
    if (frm == QLatin1String("CSV                     return i18n("Comma-Separated Values
    if (frm == QLatin1String("CZI                     return i18n("Zeiss Integrated Software RAW (ZISRAW)
    if (frm == QLatin1String("DCM, DC3, DIC, DICM     return i18n("DICOM - Digital Imaging and Communications in Medicine
    if (frm == QLatin1String("DCP                     return i18n("DNG Camera Profile (DNG-like)
    if (frm == QLatin1String("DCR                     return i18n("Kodak Digital Camera RAW (TIFF-based)
    if (frm == QLatin1String("DFONT                   return i18n("Macintosh Data Fork Font
    if (frm == QLatin1String("DIVX                    return i18n("DivX media format (ASF-based)
    if (frm == QLatin1String("DJVU, DJV               return i18n("DjVu image (AIFF-like)
    if (frm == QLatin1String("DNG                     return i18n("Digital Negative (TIFF-based)
    if (frm == QLatin1String("DOC, DOT                return i18n("Microsoft Word Document/Template (FPX-like)
    if (frm == QLatin1String("DOCX, DOCM              return i18n("Office Open XML Document [Macro-enabled]
    if (frm == QLatin1String("DOTX, DOTM              return i18n("Office Open XML Document Template [Macro-enabled]
    ...
    if (frm == QLatin1String("DSS, DS2                return i18n("Digital Speech Standard [2]
    ...
    if (frm == QLatin1String("DVB                     return i18n("Digital Video Broadcasting (QuickTime-based)
    if (frm == QLatin1String("DVR-MS                  return i18n("Microsoft Digital Video Recording (ASF-based)
    if (frm == QLatin1String("EIP                     return i18n("Capture One Enhanced Image Package (ZIP-based)
    if (frm == QLatin1String("EPS, EPSF, PS           return i18n("[Encapsulated] PostScript Format
    if (frm == QLatin1String("EPUB                    return i18n("Electronic Publication (ZIP/XML-based)
    if (frm == QLatin1String("ERF                     return i18n("Epson RAW Format (TIFF-based)
    if (frm == QLatin1String("EXE, DLL                return i18n("DOS/Windows executable and library files
    if (frm == QLatin1String("EXIF                    return i18n("Exchangeable Image File Format metadata (TIFF-based)
    if (frm == QLatin1String("EXR                     return i18n("Open EXR (Extended Range)
    if (frm == QLatin1String("EXV                     return i18n("Exiv2 metadata file (JPEG-based)
    if (frm == QLatin1String("F4A, F4B, F4P, F4V      return i18n("Adobe Flash Player 9+ Audio/Video (QuickTime-based)
    if (frm == QLatin1String("FFF                     return i18n("Hasselblad Flexible File Format (TIFF-based)
    ...
    if (frm == QLatin1String("FLA                     return i18n("Macromedia/Adobe Flash project (FPX-like)
    ...
    if (frm == QLatin1String("GPR                     return i18n("GoPro RAW (DNG-based)
    if (frm == QLatin1String("GZ, GZIP                return i18n("GNU ZIP compressed archive
    if (frm == QLatin1String("HDP, WDP, JXR           return i18n("Windows HD Photo / Media Photo / JPEG XR (TIFF-based)
    if (frm == QLatin1String("HDR                     return i18n("Radiance RGBE High Dynamic-Range
    if (frm == QLatin1String("HEIC, HEIF, HIF         return i18n("High Efficiency Image Format (QuickTime-based)
    ...
    if (frm == QLatin1String("IDML                    return i18n("Adobe InDesign Markup Language (ZIP/XML-based)
