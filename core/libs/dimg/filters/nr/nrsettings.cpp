      ...
      d(new Private)
{
    ...
    d->advExpanderBox->addItem(d->luminanceBox,
                               QIcon(QStandardPaths::locate(QStandardPaths::AppDataLocation, QLatin1String("digikam/data/colors-luma.png"))),
                               i18n("Luminance"),
                               QLatin1String("Luminance"), true);
    d->advExpanderBox->addItem(d->chrominanceBlueBox,
                               QIcon(QStandardPaths::locate(QStandardPaths::AppDataLocation, QLatin1String("digikam/data/colors-chromablue.png"))),
                               i18n("Chrominance Blue"),
                               QLatin1String("ChrominanceBlue"), true);
    d->advExpanderBox->addItem(d->chrominanceRedBox,
                               QIcon(QStandardPaths::locate(QStandardPaths::AppDataLocation, QLatin1String("digikam/data/colors-chromared.png"))),
