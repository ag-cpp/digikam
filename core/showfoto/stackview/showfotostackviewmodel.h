...
#ifndef SHOWFOTO_STACK_VIEW_MODEL_H
#define SHOWFOTO_STACK_VIEW_MODEL_H
...
class ShowfotoStackViewModel : public QStandardItemModel
{
    Q_OBJECT

public:

    explicit ShowfotoStackViewModel(ShowfotoStackViewList* const view);
    ~ShowfotoStackViewModel()                              override;
...
#endif // SHOWFOTO_STACK_VIEW_MODEL_H
