...
# Copyright (C) 2018 by George Cave, <gcave at stablecoder dot ca>
#
...
if(USE_SANITIZER)
    ...
    if(UNIX)
        ...
        if(USE_SANITIZER MATCHES "([Aa]ddress);([Uu]ndefined)" OR
           USE_SANITIZER MATCHES "([Uu]ndefined);([Aa]ddress)")
