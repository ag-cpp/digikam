...
#define DIGIKAM_VKONTAKTE_NOTEJOB_H
...
class NoteJob : public VkontakteJob
{
    Q_OBJECT

public:

    explicit NoteJob(const QString& accessToken, int nid);
    ~NoteJob();
...
#endif // DIGIKAM_VKONTAKTE_NOTEJOB_H
