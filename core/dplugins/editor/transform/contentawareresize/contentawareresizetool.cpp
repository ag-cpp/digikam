      ...
      d(new Private)
{
    ...
    d->redMaskTool->setIcon(QIcon(QStandardPaths::locate(QStandardPaths::AppDataLocation, QLatin1String("digikam/data/indicator-red.png"))));
    ...
    d->greenMaskTool->setIcon(QIcon(QStandardPaths::locate(QStandardPaths::AppDataLocation, QLatin1String("digikam/data/indicator-green.png"))));
    ...
    d->eraseMaskTool->setIcon(QIcon(QStandardPaths::locate(QStandardPaths::AppDataLocation, QLatin1String("digikam/data/indicator-gray.png"))));
