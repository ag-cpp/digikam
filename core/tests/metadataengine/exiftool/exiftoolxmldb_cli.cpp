        ...
        if (e1.tagName() == QLatin1String("table"))
        {
            ...
            for (QDomNode n2 = e1.firstChild() ; !n2.isNull() ; n2 = n2.nextSibling())
            {
                ...
                if (e2.tagName() == QLatin1String("tag"))
                {
                    ...
                    else if (etTag.startsWith(QLatin1String("XMP.XMP-xmp.")))
                    {
                        exiv2TagPre = QString::fromLatin1("Xmp.xmp.");
                    ...
                    else if (etTag.startsWith(QLatin1String("XMP.XMP-xmpRights.")))
                    {
                        exiv2TagPre = QString::fromLatin1("Xmp.xmpRights.");
                    ...
                    else if (etTag.startsWith(QLatin1String("XMP.XMP-xmpMM.")))
                    {
                        exiv2TagPre = QString::fromLatin1("Xmp.xmpMM.");
                    ...
                    else if (etTag.startsWith(QLatin1String("XMP.XMP-xmpBJ.")))
                    {
                        exiv2TagPre = QString::fromLatin1("Xmp.xmpBJ.");
