 ...
 */
class QtAvTestDataDir : public TestDataDir
{
public:

    QDir videoDir() { return dir(QString::fromUtf8("video")); }

    // Video files
    QString videoPath(QString name) { return videoDir().filePath(name); }

    /** Audio codec known to be supported on all three KDE CI machines as of 2022-10-10. */
    QString basemediav1_mp4() { return videoPath(QString::fromUtf8("basemediav1.mp4")); }

    /** Video and audio codec known to be supported on all three KDE CI machines as of 2022-10-10. */
    QString mpeg2_mp4() { return videoPath(QString::fromUtf8("mpeg2.mp4")); }

    QString mpeg4_mp4() { return videoPath(QString::fromUtf8("mpeg4.mp4")); }
    QString riffMpeg_avi() { return videoPath(QString::fromUtf8("riffMpeg.avi")); }

    
    QtAvTestDataDir()
        : TestDataDir(QString::fromUtf8("core/tests/video/qtav"))
    {
    }
