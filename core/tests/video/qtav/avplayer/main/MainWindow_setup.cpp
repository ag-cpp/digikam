...
void MainWindow::initPlayer()
{
    ...
    if (!vo || !vo->isAvailable() || !vo->widget())
    {
        QMessageBox::critical(nullptr, QString::fromLatin1("AVPlayer"),
                              QString::fromUtf8("Video renderer is not available on your platform!"));
    }
...
void MainWindow::initAudioTrackMenu()
{
    ...
    if (!d->pPlayer)
    {
        a = d->pAudioTrackMenu->addAction(QString::fromUtf8("External"));
        a->setData(-1);
        a->setCheckable(true);
        a->setChecked(false);
        as.push_back(a);
...
*/
    ...
    d->pSpeed->setToolTip(QString::fromUtf8("Speed. Ctrl+Up/Down"));
    ...
    d->pOpenBtn->setToolTip(QString::fromUtf8("Open"));
    ...
    d->pCaptureBtn->setToolTip(QString::fromUtf8("Capture"));
    d->pCaptureBtn->setIcon(QIcon::fromTheme(QLatin1String("media-record")));
    d->pVolumeBtn                     = new QToolButton();
    d->pVolumeBtn->setToolTip(QString::fromUtf8("Volume"));
...
*/
    ...
    d->pMenu->addAction(QString::fromUtf8("Open Url"), this, SLOT(openUrl()));
    d->pMenu->addSeparator();

    QString appDataDir              = QStandardPaths::writableLocation(QStandardPaths::AppDataLocation);

    subMenu                         = new QMenu(QString::fromUtf8("Play list"));
    ...
    subMenu                         = new QMenu(QString::fromUtf8("History"));
    d->pMenu->addMenu(subMenu);
    ...
    d->pMenu->addSeparator();
/*
    d->pMenu->addAction(QString::fromUtf8("Report"))->setEnabled(false); // report bug, suggestions etc. using maillist?
*/
    d->pMenu->addAction(QString::fromUtf8("About"), this, SLOT(about()));
    d->pMenu->addAction(QString::fromUtf8("Setup"), this, SLOT(setup()));
    d->pMenu->addSeparator();
    d->pMenuBtn->setMenu(d->pMenu);
    d->pMenu->addSeparator();

    subMenu                         = new QMenu(QString::fromUtf8("Speed"));
    d->pMenu->addMenu(subMenu);
    ...
    subMenu                         = new ClickableMenu(QString::fromUtf8("Repeat"));
    d->pMenu->addMenu(subMenu);
/*
    subMenu->setEnabled(false);
*/
    d->pRepeatEnableAction            = subMenu->addAction(QString::fromUtf8("Enable"));
    ...
    d->pRepeatBox->setToolTip(QString::fromLatin1("-1: ") + QString::fromUtf8("infinity"));
    connect(d->pRepeatBox, SIGNAL(valueChanged(int)), SLOT(setRepeateMax(int)));
    QLabel* pRepeatLabel            = new QLabel(QString::fromUtf8("Times"));
    QHBoxLayout* hb                 = new QHBoxLayout;
    hb->addWidget(pRepeatLabel);
    hb->addWidget(d->pRepeatBox);
    QVBoxLayout* const vb           = new QVBoxLayout;
    vb->addLayout(hb);
    pRepeatLabel                    = new QLabel(QString::fromUtf8("From"));
    d->pRepeatA                       = new QTimeEdit();
    d->pRepeatA->setDisplayFormat(QString::fromLatin1("HH:mm:ss"));
    d->pRepeatA->setToolTip(QString::fromUtf8("negative value means from the end"));
    ...
    vb->addLayout(hb);
    pRepeatLabel                    = new QLabel(QString::fromUtf8("To"));
    d->pRepeatB                       = new QTimeEdit();
    d->pRepeatB->setDisplayFormat(QString::fromLatin1("HH:mm:ss"));
    d->pRepeatB->setToolTip(QString::fromUtf8("negative value means from the end"));
    ...
    subMenu                         = new ClickableMenu(QString::fromUtf8("Clock"));
    d->pMenu->addMenu(subMenu);
    ...
    subMenu->addAction(QString::fromUtf8("Auto"))->setData(-1);
    subMenu->addAction(QString::fromUtf8("Audio"))->setData(AVClock::AudioClock);
    subMenu->addAction(QString::fromUtf8("Video"))->setData(AVClock::VideoClock);
    ...
    autoClockAction->setToolTip(QString::fromUtf8("Take effect in next playback"));

    subMenu                         = new ClickableMenu(QString::fromUtf8("Subtitle"));
    d->pMenu->addMenu(subMenu);
    QAction* act                    = subMenu->addAction(QString::fromUtf8("Enable"));
    ...
    act                             = subMenu->addAction(QString::fromUtf8("Auto load"));
    act->setCheckable(true);
    ...
    subMenu->addAction(QString::fromUtf8("Open"), this, SLOT(openSubtitle()));

    wgt                             = new QWidget();
    hb                              = new QHBoxLayout();
    wgt->setLayout(hb);
    hb->addWidget(new QLabel(QString::fromUtf8("Engine")));
    ...
    box->setToolTip(QString::fromUtf8("FFmpeg supports more subtitles but only render plain text\n"
                                   "LibASS supports 'ass' styles"));

    wgt                             = new QWidget();
    hb                              = new QHBoxLayout();
    wgt->setLayout(hb);
    hb->addWidget(new QLabel(QString::fromUtf8("Charset")));
    box                             = new QComboBox();
    hb->addWidget(box);
    pWA                             = new QWidgetAction(0);
    pWA->setDefaultWidget(wgt);
    subMenu->addAction(pWA);                    // must add action after the widget action is ready. is it a Qt bug?
    box->addItem(QString::fromUtf8("Auto detect"), QString::fromLatin1("AutoDetect"));
    box->addItem(QString::fromUtf8("System"),      QString::fromLatin1("System"));
    ...
    box->setToolTip(QString::fromUtf8("Auto detect requires libchardet"));

    subMenu                         = new ClickableMenu(QString::fromUtf8("Audio track"));
    d->pMenu->addMenu(subMenu);
    ...
    subMenu                         = new ClickableMenu(QString::fromUtf8("Channel"));
    d->pMenu->addMenu(subMenu);
    ...
    subMenu->addAction(QString::fromUtf8("As input"))->setData(AudioFormat::ChannelLayout_Unsupported);
    subMenu->addAction(QString::fromUtf8("Stereo"))->setData(AudioFormat::ChannelLayout_Stereo);
    subMenu->addAction(QString::fromUtf8("Mono (center)"))->setData(AudioFormat::ChannelLayout_Center);
    subMenu->addAction(QString::fromUtf8("Left"))->setData(AudioFormat::ChannelLayout_Left);
    subMenu->addAction(QString::fromUtf8("Right"))->setData(AudioFormat::ChannelLayout_Right);
    ...
    subMenu                         = new QMenu(QString::fromUtf8("Aspect ratio"), d->pMenu);
    d->pMenu->addMenu(subMenu);

    connect(subMenu, SIGNAL(triggered(QAction*)),
            this, SLOT(switchAspectRatio(QAction*)));

    d->pARAction                      = subMenu->addAction(QString::fromUtf8("Video"));
    d->pARAction->setData(0);
    subMenu->addAction(QString::fromUtf8("Window"))->setData(-1);
    subMenu->addAction(QString::fromLatin1("4:3"))->setData(4.0   / 3.0);
    subMenu->addAction(QString::fromLatin1("16:9"))->setData(16.0 / 9.0);
    subMenu->addAction(QString::fromUtf8("Custom"))->setData(-2);
    ...
    subMenu                         = new ClickableMenu(QString::fromUtf8("Color space"));
    d->pMenu->addMenu(subMenu);
    ...
    subMenu                         = new ClickableMenu(QString::fromUtf8("Decoder"));
    d->pMenu->addMenu(subMenu);
    ...
    subMenu                         = new ClickableMenu(QString::fromUtf8("Renderer"));
    d->pMenu->addMenu(subMenu);
...
void MainWindow::changeVO(QAction* action)
{
    ...
    else
    {
        action->toggle(); // check state changes if clicked
        QMessageBox::critical(nullptr, QString::fromLatin1("AVPlayer"),
                              QString::fromUtf8("not available on your platform!"));
...
bool MainWindow::setRenderer(QtAV::VideoRenderer* const renderer)
{
    ...
    if (!renderer->widget())
    {
        QMessageBox::warning(nullptr, QString::fromLatin1("AVPlayer"),
                             QString::fromUtf8("Can not use this renderer"));
