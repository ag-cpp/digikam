...
export CLAZY_CHECKS="level1,virtual-call-ctor,no-fully-qualified-moc-types,no-overloaded-signal,no-qproperty-without-notify,no-qstring-arg,no-inefficient-qlist-soft,no-qstring-insensitive-allocation"
