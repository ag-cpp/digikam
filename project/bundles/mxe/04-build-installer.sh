...
# The following code to do lets all debug symbols in each digiKam components, else size will be largest than 2Gb.
...
TARGET_INSTALLER=digiKam-$DK_RELEASEID$DK_SUBVER-Qt5-Win64$DEBUG_SUF.exe
PORTABLE_FILE=digiKam-$DK_RELEASEID$DK_SUBVER-Qt5-Win64$DEBUG_SUF.tar.xz
CHECKSUM_FILE=digiKam-$DK_RELEASEID$DK_SUBVER-Qt5-Win64$DEBUG_SUF.sum
