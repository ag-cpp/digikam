...
#
# SPDX-FileCopyrightText:      2005 by Mark Kretschmann, <kretschmann at kde dot org>
# SPDX-FileCopyrightText:      2014 by Nicolas Lécureuil, <kde at nicolaslecureuil dot fr>
...
i18nlangs.each_line do |lang|
    ...
    if (lang != nil && lang != "")
        ...
        list.each do |part|
            ...
            if isWindows
                `svn cat svn://anonsvn.kde.org/home/kde/#{branch}/l10n-kf5/#{lang}/docs/digikam-doc/digikam/#{part}.docbook > digikam/#{part}.docbook 2> nul`
            else
    ...
    if (lang != nil && lang != "")
        ...
        if (File.exists?(lang))
            ...
            list.each do |part|
                ...
                if isWindows
                    `svn cat svn://anonsvn.kde.org/home/kde/#{branch}/l10n-kf5/#{lang}/docs/digikam-doc/showfoto/#{part}.docbook > showfoto/#{part}.docbook 2> nul`
                else
